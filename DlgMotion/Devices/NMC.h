...
typedef enum { NMC_DEVICE_BOARD = 0, NMC_DEVICE_IOIN = 19, NMC_DEVICE_IOOUT = 19 } NMC_DEVICE_ID;		// for 1호기
//typedef enum { NMC_DEVICE_BOARD = 0, NMC_DEVICE_IOIN = 5, NMC_DEVICE_IOOUT = 5 } NMC_DEVICE_ID;		// for 2호기
